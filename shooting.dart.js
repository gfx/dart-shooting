...
function Status(scoreboardName, stageName) {
  ...
  get$$document().body.get$on().get$mouseDown().add(touchStart, false);
  get$$document().body.get$on().get$touchStart().add(touchStart, false);
  ...
  get$$document().body.get$on().get$mouseMove().add(touchMove, false);
  get$$document().body.get$on().get$touchMove().add(touchMove, false);
}
