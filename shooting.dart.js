...
HashMapImplementation_dart_core_String$Element.prototype.forEach$1 = function($0) {
  return this.forEach(to$call$2($0));
};
...
HashMapImplementation_dart_core_String$Bullet.prototype.forEach$1 = function($0) {
  return this.forEach(to$call$2($0));
};
...
HashMapImplementation_dart_core_String$Rock.prototype.forEach$1 = function($0) {
  return this.forEach(to$call$2($0));
};
...
function Status(scoreboardName, stageName) {
  ...
  get$$document().body.get$on().get$mouseDown().add($wrap_call$1(touchStart), false);
  get$$document().body.get$on().get$touchStart().add($wrap_call$1(touchStart), false);
  ...
  get$$document().body.get$on().get$mouseMove().add($wrap_call$1(touchMove), false);
  get$$document().body.get$on().get$touchMove().add($wrap_call$1(touchMove), false);
}
